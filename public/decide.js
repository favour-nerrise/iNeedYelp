const foodArray = ["Afghan", "African", "American (New)", "American (Traditional)", "Arabian", "Argentine", "Armenian", "Asian Fusion", "Austrailian",
...
//active life
const activeArray = ["ATV Rentals/Tours", "Airsoft", "Amateur Sports Teams", "Amusement Parks", "Aquariums", "Archery", "Badminton", "Baseball Fields", "Basketball Courts",
...
//nightlife
const nightlifeArray = ["Adult Entertainment", "Bar Crawl", "Absinthe Bars", "Beach Bars", "Beer Bar", "Champagne Bars", "Cocktail Bars", "Dive Bars", "Drive-Thru Bars",
...
const entertainmentArray = ["Arcades", "Art Galleries", "Betting Centers", "Bingo Halls", "Botanical Gardens", "Cabaret", "Casinos", "Castles", "Choirs", "Cinema",
